...
<!-- alef:hash:2c5c43862267a265678d6ff9cd9784bf9cf2d81d7224074343f5b630d6e66d56 -->
...
int main(void) {
    const char *input_json_base = "{\"bytes\":\"__ALEF_DOC_FILE_0__\",\"config\":{\"disable_ocr\":true,\"force_ocr\":true},\"filename\":\"fake_text.txt\",\"kind\":\"bytes\",\"mime_type\":\"text/plain\"}";
    FILE *input_file_0 = fopen("text/fake_text.txt", "rb");
    ...
    free(input_json_0);
    XBERGAlefHandle config_handle = xberg_extraction_config_from_json("{\"disable_ocr\":true,\"force_ocr\":true}");
