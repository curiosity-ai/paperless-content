...
// alef:hash:161d9f0d5c6070b6b3607751c9c3f643f152d1466b2ef86fea3232a83f6f0e93
...
namespace Xberg
{
    ...
    public class PluginApiTests
    {
        ...
        public void Test_UnregisterEmbeddingBackendAfterRegister()
        {
            ...
            var exception = Record.Exception(() => XbergConverter.UnregisterEmbeddingBackend("test-embedding-backend"));
        ...
        public void Test_UnregisterPostProcessorAfterRegister()
        {
            ...
            var exception = Record.Exception(() => XbergConverter.UnregisterPostProcessor("test-processor"));
            Assert.Null(exception);
        }
        ...
        public void Test_UnregisterRerankerBackend()
        {
            ...
            var exception = Record.Exception(() => XbergConverter.UnregisterRerankerBackend("test-reranker-backend"));
            Assert.Null(exception);
        }
        ...
        public void Test_UnregisterTokenizerBackendAfterRegister()
        {
            ...
            var exception = Record.Exception(() => XbergConverter.UnregisterTokenizerBackend("test-tokenizer-backend"));
            Assert.Null(exception);
        }
        ...
        public void Test_UnregisterValidatorAfterRegister()
        {
            ...
            var exception = Record.Exception(() => XbergConverter.UnregisterValidator("test-validator"));
            Assert.Null(exception);
        }
        ...
        class TestStub_RegisterPostProcessorTraitBridge : IPostProcessor
        {
            ...
            public ProcessingStage ProcessingStage { get; } = new ProcessingStage();
