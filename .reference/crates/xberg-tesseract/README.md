...
```toml
[dependencies]
xberg-tesseract = "1.0.0-rc.1"
# or explicitly:
xberg-tesseract = { version = "1.0.0-rc.1", features = ["static-linking"] }
```
...
```toml
[dependencies]
xberg-tesseract = { version = "1.0.0-rc.1", features = ["dynamic-linking"], default-features = false }
```
...
For more detailed information, please check the [API documentation](https://docs.rs/xberg-tesseract).
