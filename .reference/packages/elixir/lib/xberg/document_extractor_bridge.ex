...
# alef:hash:aef5653cb10d2623c6542c47b1ee1b6e1737eb9451fc4eaa17a6556217373201
# To regenerate: alef generate
# To verify freshness: alef verify

defmodule XbergDocumentExtractorBridge do
  @moduledoc """
  GenServer bridge for DocumentExtractor implementation in xberg.
  ...
  def register(impl_module) do
    ...
    Xberg.Native.register_document_extractor(pid, plugin_name, implemented_methods)
  end
end
