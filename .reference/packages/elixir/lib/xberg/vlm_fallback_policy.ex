...
# alef:hash:a1306167c11678b4b78fd98f88d8bad5760b892ff3511b17dcc897e268843d08
...
defmodule Xberg.VlmFallbackPolicy do
  ...
  @type on_low_quality :: %{mode: :on_low_quality, quality_threshold: float()}
  ...
  def wire_value(:on_low_quality), do: "on_low_quality"
