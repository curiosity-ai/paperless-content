...
# alef:hash:b2a6e9d575f74c5c7a50c04fb1f32f348aebb7a1f94218063ad9664c1f0fcb6d
# To regenerate: alef generate
# To verify freshness: alef verify

defmodule XbergTokenizerBackendBridge do
  @moduledoc """
  GenServer bridge for TokenizerBackend implementation in xberg.
  ...
  impl_module should be a module that implements the TokenizerBackend trait methods.
  """
  ...
  def register(impl_module) do
    ...
    Xberg.Native.register_tokenizer_backend(pid, plugin_name, implemented_methods)
  end
end
