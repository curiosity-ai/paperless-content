...
# alef:hash:8b04a3d74287bb4655301cbee72d7a51cc9e79fcdf150fc060d4184781add286
...
defmodule Xberg.PSMMode do
  ...
  def wire_value(:osd_only), do: "OsdOnly"
  def wire_value(:auto_osd), do: "AutoOsd"
  def wire_value(:auto_only), do: "AutoOnly"
  def wire_value(:auto), do: "Auto"
  def wire_value(:single_column), do: "SingleColumn"
  def wire_value(:single_block_vertical), do: "SingleBlockVertical"
  def wire_value(:single_block), do: "SingleBlock"
  def wire_value(:single_line), do: "SingleLine"
  def wire_value(:single_word), do: "SingleWord"
  def wire_value(:circle_word), do: "CircleWord"
  def wire_value(:single_char), do: "SingleChar"
end
