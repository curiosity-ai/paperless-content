...
// alef:hash:23e049afb281a0b49ada8b9cb93741b99cc3567bfe881bfc7e80af7369f44a5e
...
public record PptxExtractionResult(
    ...
    @JsonProperty("hyperlinks") List<PresentationHyperlink> hyperlinks,
    ...
    public PptxExtractionResult{
        if (hyperlinks == null) { hyperlinks = List.of(); }
        if (officeMetadata == null) { officeMetadata = Map.of(); }
    }
    ...
    public static final class Builder {
        ...
        @Nullable private List<PresentationHyperlink> hyperlinks = List.of();
        @JsonProperty("office_metadata")
        @Nullable private Map<String, String> officeMetadata = Map.of();
        ...
        public Builder withHyperlinks(final @Nullable List<PresentationHyperlink> value) {
