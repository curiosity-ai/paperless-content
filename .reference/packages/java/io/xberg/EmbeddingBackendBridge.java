...
// alef:hash:275083d1bbe3df7b33d0d01b3a6bc29f4ca72b14c9875a8712c1692d8309392e
...
public final class EmbeddingBackendBridge implements AutoCloseable {
    ...
    private static final System.Logger LOGGER = System.getLogger(EmbeddingBackendBridge.class.getName());
    ...
    private long handleDimensions(MemorySegment userData) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'dimensions' threw; returning default", e);
            return 0L;
        }
    }
