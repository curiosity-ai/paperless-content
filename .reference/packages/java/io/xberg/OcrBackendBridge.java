...
// alef:hash:5015e4c34dd8373518b019b520f97bfce74676d135f35e453c819c776d6eab98
...
public final class OcrBackendBridge implements AutoCloseable {
    ...
    private static final System.Logger LOGGER = System.getLogger(OcrBackendBridge.class.getName());
    ...
    // C vtable: 17 fields (4 plugin methods + 11 trait methods + free_string + free_user_data)
    ...
    private void initializeStubs() throws ReflectiveOperationException {
        ...
        initStubConfidenceSemantics(12L * ValueLayout.ADDRESS.byteSize());
        initStubPageOrientationHandling(13L * ValueLayout.ADDRESS.byteSize());
        initStubProcessDocument(14L * ValueLayout.ADDRESS.byteSize());
        initStubFreeString(15L * ValueLayout.ADDRESS.byteSize());
        initStubFreeUserData(16L * ValueLayout.ADDRESS.byteSize());
    }
    ...
    private void initStubConfidenceSemantics(long offset) throws ReflectiveOperationException {
        var stubConfidenceSemantics = LINKER.upcallStub(LOOKUP.bind(this, "handleConfidenceSemantics",
            MethodType.methodType(int.class, MemorySegment.class, MemorySegment.class, MemorySegment.class)),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS),
            arena);
        vtable.set(ValueLayout.ADDRESS, offset, stubConfidenceSemantics);
    }

    private void initStubPageOrientationHandling(long offset) throws ReflectiveOperationException {
        var stubPageOrientationHandling = LINKER.upcallStub(LOOKUP.bind(this, "handlePageOrientationHandling",
            MethodType.methodType(int.class, MemorySegment.class, MemorySegment.class, MemorySegment.class)),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS),
            arena);
        vtable.set(ValueLayout.ADDRESS, offset, stubPageOrientationHandling);
    }
    ...
    private long handleSupportsLanguage(MemorySegment userData, MemorySegment lang_in) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'supports_language' threw; returning default", e);
            return 0L;
        }
    }
    ...
    private long handleSupportsTableDetection(MemorySegment userData) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'supports_table_detection' threw; returning default", e);
            return 0L;
        }
    }
    ...
    private long handleSupportsDocumentProcessing(MemorySegment userData) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'supports_document_processing' threw; returning default", e);
            return 0L;
        }
    }
    ...
    private long handleEmitsStructuredMarkdown(MemorySegment userData) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'emits_structured_markdown' threw; returning default", e);
            return 0L;
        }
    }

    private int handleConfidenceSemantics(MemorySegment userData, MemorySegment outResult, MemorySegment outError) {
        try {
            ConfidenceSemantics callbackResult = impl.confidence_semantics();
            String json = JSON.writeValueAsString(callbackResult);
            MemorySegment jsonCs = arena.allocateFrom(json);
            outResult.set(ValueLayout.ADDRESS, 0, jsonCs);
            return 0;
    ...
    private int handlePageOrientationHandling(MemorySegment userData, MemorySegment outResult, MemorySegment outError) {
        try {
            PageOrientationHandling callbackResult = impl.page_orientation_handling();
            String json = JSON.writeValueAsString(callbackResult);
            MemorySegment jsonCs = arena.allocateFrom(json);
            outResult.set(ValueLayout.ADDRESS, 0, jsonCs);
            return 0;
