...
// alef:hash:c95450ae64ce91e12b38836094777f07b7ce635740b234287d93387041483f1f
 ...
 *
 * {@code extract} and {@code extract_batch} return an {@code ExtractionResult} envelope whose
 * {@code results} field contains these per-document payloads.
 */
@com.fasterxml.jackson.annotation.JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(builder = ExtractedDocument.Builder.class)
public record ExtractedDocument(
    ...
    @Nullable @JsonProperty("counts") DocumentCounts counts,
    @Nullable @JsonProperty("detected_languages") List<String> detectedLanguages,
    @Nullable @JsonProperty("detected_language_confidences") List<LanguageConfidence> detectedLanguageConfidences,
    ...
    @JsonProperty("formulas") List<Formula> formulas,
    @JsonProperty("form_fields") List<PdfFormField> formFields
) {
    ...
    public ExtractedDocument{
        if (processingWarnings == null) { processingWarnings = List.of(); }
        if (formulas == null) { formulas = List.of(); }
        if (formFields == null) { formFields = List.of(); }
    }

    // CPD-OFF
    /** Jackson builder for ExtractedDocument deserialization. */
    @com.fasterxml.jackson.annotation.JsonIgnoreProperties(ignoreUnknown = true)
    ...
    public static final class Builder {
        ...
        @Nullable private DocumentCounts counts;
        @JsonProperty("detected_languages")
        @Nullable private List<String> detectedLanguages;
        @JsonProperty("detected_language_confidences")
        @Nullable private List<LanguageConfidence> detectedLanguageConfidences;
        ...
        @Nullable private List<ProcessingWarning> processingWarnings = List.of();
        ...
        @Nullable private List<Formula> formulas = List.of();
        @JsonProperty("form_fields")
        @Nullable private List<PdfFormField> formFields = List.of();
        ...
        /** Sets the counts field. */
        @JsonProperty("counts")
        public Builder withCounts(final @Nullable DocumentCounts value) {
            this.counts = value;
            return this;
        }
        ...
        /** Sets the detectedLanguageConfidences field. */
        @JsonProperty("detected_language_confidences")
        public Builder withDetectedLanguageConfidences(final @Nullable List<LanguageConfidence> value) {
            this.detectedLanguageConfidences = value;
            return this;
        }
        ...
        /** Constructs a ExtractedDocument instance from the builder's current state. */
