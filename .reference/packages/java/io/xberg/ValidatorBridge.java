...
// alef:hash:3a7fdd21a9a3f62745d3d5da13fe443ed892a1e11986eaa4c1c7610e11846759
...
public final class ValidatorBridge implements AutoCloseable {
    ...
    private static final System.Logger LOGGER = System.getLogger(ValidatorBridge.class.getName());
    ...
    private long handleShouldValidate(MemorySegment userData, MemorySegment _result_in, MemorySegment _config_in) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'should_validate' threw; returning default", e);
            return 0L;
        }
    }
