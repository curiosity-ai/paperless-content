...
// alef:hash:17e74450744e987f214e7ab1de96b96feaa9466d438c7c34e9f23e69a8af18e8
...
public record PaddleOcrConfig(
    ...
    @Nullable @JsonProperty("inference_backend") PaddleInferenceBackend inferenceBackend
) {
    ...
    public PaddleOcrConfig{
        if (detDbThresh == null) { detDbThresh = 0.3f; }
        if (detDbBoxThresh == null) { detDbBoxThresh = 0.5f; }
        if (detDbUnclipRatio == null) { detDbUnclipRatio = 1.6f; }
        if (detLimitSideLen == null) { detLimitSideLen = 1024; }
        if (recBatchNum == null) { recBatchNum = 6; }
        if (padding == null) { padding = 10; }
        if (dropScore == null) { dropScore = 0.5f; }
    }
    ...
    public static final class Builder {
        ...
        private String modelTier = "mobile";
        @JsonProperty("model_version")
        private String modelVersion = "pp-ocrv6";
        @JsonProperty("inference_backend")
        @Nullable private PaddleInferenceBackend inferenceBackend;
        ...
        @JsonProperty("inference_backend")
        public Builder withInferenceBackend(final @Nullable PaddleInferenceBackend value) {
