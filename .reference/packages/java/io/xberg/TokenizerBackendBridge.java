...
// alef:hash:d923f5e957a62e5d3b622a467226c4ac8abba64fb46aaac1f59a3c117f2ed6cf
...
public final class TokenizerBackendBridge implements AutoCloseable {
    ...
    private static final System.Logger LOGGER = System.getLogger(TokenizerBackendBridge.class.getName());
    ...
    private long handleCountTokens(MemorySegment userData, MemorySegment text_in) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'count_tokens' threw; returning default", e);
            return 0L;
        }
    }
