...
// alef:hash:3201b0f8eb7edae139f30cfe0d00a054fd50bcc6fe9584e9aa714bd36ad747e5
...
public final class PostProcessorBridge implements AutoCloseable {
    ...
    private static final System.Logger LOGGER = System.getLogger(PostProcessorBridge.class.getName());
    ...
    private long handleShouldProcess(MemorySegment userData, MemorySegment _result_in, MemorySegment _config_in) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'should_process' threw; returning default", e);
            return 0L;
        }
    }
    ...
    private long handleEstimatedDurationMs(MemorySegment userData, MemorySegment _result_in) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'estimated_duration_ms' threw; returning default", e);
            return 0L;
        }
    }
    ...
    private long handlePriority(MemorySegment userData) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'priority' threw; returning default", e);
            return 0L;
        }
    }
