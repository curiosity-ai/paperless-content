...
// alef:hash:b60371a1d2352f8ff360fcc916797d0906f3634c04c6436df97214b14ab9e2af
    ...
    try {
      return JsonSerializer.Deserialize<DocumentCounts>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DocumentCounts from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DocumentCounts from JSON: {e.Message}", e);
    }
  }
