...
// alef:hash:77abc7b5afd87bffcc42e7e09a32d2528087e79459b704642b7318f718a223b4
...
public abstract record OcrBoundingGeometry {
  ...
  public sealed record Quadrilateral(
      [property : JsonPropertyName("points")] List<OcrPoint> Points)
      : OcrBoundingGeometry;
}

/// <summary>
/// Custom converter for OcrBoundingGeometry sealed union with flattened variant
/// fields.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class OcrBoundingGeometryJsonConverter
    : JsonConverter<OcrBoundingGeometry> {
  public override OcrBoundingGeometry Read(ref Utf8JsonReader reader,
                                           Type typeToConvert,
    ...
    return tagValue switch {
      "rectangle" => JsonSerializer.Deserialize<OcrBoundingGeometry.Rectangle>(
                         flatJson, options) ??
                     throw new JsonException("Failed to deserialize variant"),
      "quadrilateral" =>
          JsonSerializer.Deserialize<OcrBoundingGeometry.Quadrilateral>(
              flatJson, options) ??
          throw new JsonException("Failed to deserialize variant"),
      // Unknown discriminator: forward compatibility for unknown variants
      _ => throw new JsonException(
          $"Unknown OcrBoundingGeometry discriminator: {tagValue}")
    };
  }

  public override void Write(Utf8JsonWriter writer, OcrBoundingGeometry value,
                             JsonSerializerOptions options) {
    ...
    case OcrBoundingGeometry.Quadrilateral v_quadrilateral:
      tag = "quadrilateral";
      inner = v_quadrilateral;
      break;
    default:
      throw new JsonException(
          $"Unknown OcrBoundingGeometry variant: {value.GetType().Name}");
    }
