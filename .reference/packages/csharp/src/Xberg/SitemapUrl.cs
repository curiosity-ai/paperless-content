...
// alef:hash:eb4f9531a7c53ee511d5c0ed034d823cb6bbcd48f7be7096b85ad84bfc73456a
    ...
    try {
      return JsonSerializer.Deserialize<SitemapUrl>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse SitemapUrl from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse SitemapUrl from JSON: {e.Message}", e);
    }
  }
