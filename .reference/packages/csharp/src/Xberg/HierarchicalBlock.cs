...
// alef:hash:3819d9b5c5fb5ad5b51ae2734475746fcebfcad2da026e3fbbf3d36b520fc1a6
...
public sealed record HierarchicalBlock {
  ...
  public HierarchicalBoundingBox
      ? Bbox {
          get; init;
        } = null;
    ...
    try {
      return JsonSerializer.Deserialize<HierarchicalBlock>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse HierarchicalBlock from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse HierarchicalBlock from JSON: {e.Message}", e);
    }
  }
