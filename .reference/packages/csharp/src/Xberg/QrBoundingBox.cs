...
// alef:hash:870157e13ff913da619eb07ae4a22ea2dac3594e63e2a1c0c577c24e1a18b1eb
    ...
    try {
      return JsonSerializer.Deserialize<QrBoundingBox>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse QrBoundingBox from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse QrBoundingBox from JSON: {e.Message}", e);
    }
  }
