...
// alef:hash:7f736081612b2204aa24ff7e81618e9fb18802df51d5a3adee32e5bab8dae688
    ...
    try {
      return JsonSerializer.Deserialize<DetectResponse>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DetectResponse from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DetectResponse from JSON: {e.Message}", e);
    }
  }
