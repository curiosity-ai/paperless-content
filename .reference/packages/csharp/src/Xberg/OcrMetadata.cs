...
// alef:hash:20d595fd730389cad1f93c406a97e98778121b57ac047abd4df20f80b89ec818
    ...
    try {
      return JsonSerializer.Deserialize<OcrMetadata>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse OcrMetadata from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse OcrMetadata from JSON: {e.Message}", e);
    }
  }
