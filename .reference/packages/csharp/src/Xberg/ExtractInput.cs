...
// alef:hash:3aa4b67b9ac97e45ed63edd0af56bf82b69983a3fc9d9d0bf9277a52f0755311
...
public sealed record ExtractInput {
    ...
    try {
      return JsonSerializer.Deserialize<ExtractInput>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ExtractInput from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ExtractInput from JSON: {e.Message}", e);
    }
  }
  ...
  public static ExtractInput Default() {
    ...
    return JsonSerializer.Deserialize<ExtractInput>(json ?? "null",
                                                    JsonOptions)!;
  }
