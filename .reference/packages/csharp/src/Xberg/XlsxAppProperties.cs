...
// alef:hash:459f3971fe6563476374ca555169a9a91956482a73cea4c342eff3db317735e1
    ...
    try {
      return JsonSerializer.Deserialize<XlsxAppProperties>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse XlsxAppProperties from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse XlsxAppProperties from JSON: {e.Message}", e);
    }
  }
