...
// alef:hash:fc7c23c65ff8cecc2422eb8148914e49f1205522f0554bdc7fdc81c0ecb67f65
    ...
    try {
      return JsonSerializer.Deserialize<PresetSample>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse PresetSample from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse PresetSample from JSON: {e.Message}", e);
    }
  }
