...
// alef:hash:2d212d11f5a6301b89ca75fb23e0c7b8cfd144d15fc307640c9b0eb8807f1c46
    ...
    try {
      return JsonSerializer.Deserialize<ExcelSheet>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ExcelSheet from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ExcelSheet from JSON: {e.Message}", e);
    }
  }
