...
// alef:hash:f855e51370f7c4fe10241d04ed181fc585a3a2a53d0fb2b1089c13858b1d3d37
    ...
    try {
      return JsonSerializer.Deserialize<QrCode>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse QrCode from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException($"Failed to parse QrCode from JSON: {e.Message}",
                               e);
    }
  }
