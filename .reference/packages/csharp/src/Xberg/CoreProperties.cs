...
// alef:hash:e0f9a4823239a6c22ae3f9f542f493e9a08196552674b3a894439e1eb60ad65e
    ...
    try {
      return JsonSerializer.Deserialize<CoreProperties>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse CoreProperties from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse CoreProperties from JSON: {e.Message}", e);
    }
  }
