...
// alef:hash:867c2e756ec7cb8dda4ff4d6dcb54df3371bc5c30a5e6d5627c20abb9a726626
    ...
    try {
      return JsonSerializer.Deserialize<PatternMatch>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse PatternMatch from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse PatternMatch from JSON: {e.Message}", e);
    }
  }
