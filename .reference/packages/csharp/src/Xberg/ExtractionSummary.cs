...
// alef:hash:808b1e21a2549aa5ded0cffa67c91397f7309cc95e1effaf5faa404f4acb09df
...
public sealed record ExtractionSummary {
  ...
  public ulong DocumentsDownloaded {
    get; init;
  } = 0;
    ...
    try {
      return JsonSerializer.Deserialize<ExtractionSummary>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ExtractionSummary from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ExtractionSummary from JSON: {e.Message}", e);
    }
  }
