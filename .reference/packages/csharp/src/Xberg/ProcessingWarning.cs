...
// alef:hash:a93326a5e256244c1c2adfa7c102faec23a34d73a476b010ffb8158b7939bce8
    ...
    try {
      return JsonSerializer.Deserialize<ProcessingWarning>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ProcessingWarning from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ProcessingWarning from JSON: {e.Message}", e);
    }
  }
