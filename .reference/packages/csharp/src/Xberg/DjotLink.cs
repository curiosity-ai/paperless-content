...
// alef:hash:7eba75bf7040467d0ae972f85920bd4434b8b2a62973ec3dbe492bb81134caa7
    ...
    try {
      return JsonSerializer.Deserialize<DjotLink>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DjotLink from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DjotLink from JSON: {e.Message}", e);
    }
  }
