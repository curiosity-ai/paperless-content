...
// alef:hash:cdb5fd6a726b0984a5c5cfc6b14a81dca459962e34254f5d0d3737ebd769c986
    ...
    try {
      return JsonSerializer.Deserialize<ImageMetadataType>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ImageMetadataType from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ImageMetadataType from JSON: {e.Message}", e);
    }
  }
