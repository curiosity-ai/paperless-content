...
// alef:hash:85844ed96c192fa1a958fc2911da0c3bbcd84e9ddb04e82e1a973337c108d8aa
...
public abstract record ImageOutputFormat {
  ...
  /// and a warning is emitted. 80 is a reasonable default.
  ///
  /// The encode path requires the `heic` feature; on builds without it,
  /// selecting this variant returns an `EncodeFailed` warning and leaves the
  /// image untouched.
  /// </summary>
...
/// <summary>
/// Custom converter for ImageOutputFormat sealed union with flattened variant
/// fields.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class ImageOutputFormatJsonConverter
    : JsonConverter<ImageOutputFormat> {
  public override ImageOutputFormat Read(ref Utf8JsonReader reader,
                                         Type typeToConvert,
    ...
    return tagValue switch {
      ...
      "png" => new ImageOutputFormat.Png(),
      "jpeg" => JsonSerializer.Deserialize<ImageOutputFormat.Jpeg>(flatJson,
                                                                   options) ??
                throw new JsonException("Failed to deserialize variant"),
      "webp" => JsonSerializer.Deserialize<ImageOutputFormat.Webp>(flatJson,
                                                                   options) ??
                throw new JsonException("Failed to deserialize variant"),
      "heif" => JsonSerializer.Deserialize<ImageOutputFormat.Heif>(flatJson,
                                                                   options) ??
                throw new JsonException("Failed to deserialize variant"),
      "svg" => new ImageOutputFormat.Svg(),
      // Unknown discriminator: forward compatibility for unknown variants
      _ => throw new JsonException(
          $"Unknown ImageOutputFormat discriminator: {tagValue}")
    };
  }

  public override void Write(Utf8JsonWriter writer, ImageOutputFormat value,
                             JsonSerializerOptions options) {
    ...
    case ImageOutputFormat.Native _:
      ...
      inner = null;
      break;
    case ImageOutputFormat.Png _:
      tag = "png";
      inner = null;
      break;
    case ImageOutputFormat.Jpeg v_jpeg:
      tag = "jpeg";
      inner = v_jpeg;
      break;
    case ImageOutputFormat.Webp v_webp:
      tag = "webp";
      inner = v_webp;
      break;
    case ImageOutputFormat.Heif v_heif:
      tag = "heif";
      inner = v_heif;
      break;
    case ImageOutputFormat.Svg _:
      tag = "svg";
      inner = null;
      break;
    default:
      throw new JsonException(
          $"Unknown ImageOutputFormat variant: {value.GetType().Name}");
    }
