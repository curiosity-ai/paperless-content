...
// alef:hash:8cdb012395727d6c13c949ee375c9b3aea971f54291a454388f656d0b7436152
    ...
    try {
      return JsonSerializer.Deserialize<Citation>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse Citation from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse Citation from JSON: {e.Message}", e);
    }
  }
