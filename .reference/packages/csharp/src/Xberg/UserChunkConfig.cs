...
// alef:hash:46df153987e196a74d68672c4010734ebb77118a52273e8f6d99e5aef3857896
    ...
    try {
      return JsonSerializer.Deserialize<UserChunkConfig>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse UserChunkConfig from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse UserChunkConfig from JSON: {e.Message}", e);
    }
  }
