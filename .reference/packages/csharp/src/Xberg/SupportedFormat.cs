...
// alef:hash:743259b2b8f07c0fbd5f6fb23531aa790921b11f5ffd7bb6f54105135c983643
...
///
/// Represents a file extension and its corresponding MIME type that Xberg can
/// process.
/// </summary>
    ...
    try {
      return JsonSerializer.Deserialize<SupportedFormat>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse SupportedFormat from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse SupportedFormat from JSON: {e.Message}", e);
    }
  }
