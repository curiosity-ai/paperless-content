...
// alef:hash:0a7aa4c31844b5f486cf0cd0da7b5112a79e9f6c2596542400fd870ae1523526
...
/// <summary>
/// Custom converter for SparseEmbeddingModelType sealed union with flattened
/// variant fields.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class SparseEmbeddingModelTypeJsonConverter
    : JsonConverter<SparseEmbeddingModelType> {
  public override SparseEmbeddingModelType Read(ref Utf8JsonReader reader,
                                                Type typeToConvert,
    ...
    return tagValue switch {
      "preset" => JsonSerializer.Deserialize<SparseEmbeddingModelType.Preset>(
                      flatJson, options) ??
                  throw new JsonException("Failed to deserialize variant"),
      "custom" => JsonSerializer.Deserialize<SparseEmbeddingModelType.Custom>(
                      flatJson, options) ??
                  throw new JsonException("Failed to deserialize variant"),
      "plugin" => JsonSerializer.Deserialize<SparseEmbeddingModelType.Plugin>(
                      flatJson, options) ??
                  throw new JsonException("Failed to deserialize variant"),
      // Unknown discriminator: forward compatibility for unknown variants
      _ => throw new JsonException(
          $"Unknown SparseEmbeddingModelType discriminator: {tagValue}")
    };
  }

  public override void Write(Utf8JsonWriter writer,
                             SparseEmbeddingModelType value,
                             JsonSerializerOptions options) {
    ...
    case SparseEmbeddingModelType.Preset v_preset:
      ...
      inner = v_preset;
      break;
    case SparseEmbeddingModelType.Custom v_custom:
      tag = "custom";
      inner = v_custom;
      break;
    case SparseEmbeddingModelType.Plugin v_plugin:
      tag = "plugin";
      inner = v_plugin;
      break;
    default:
      throw new JsonException(
          $"Unknown SparseEmbeddingModelType variant: {value.GetType().Name}");
    }
