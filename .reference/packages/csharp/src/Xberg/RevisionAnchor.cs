...
// alef:hash:d359147ecca56da9276067a375b3186ba5eb7efcaf4b492a61f77ec1ab75a533
...
public abstract record RevisionAnchor {
  ...
  /// </summary>
  public sealed record Page([property : JsonPropertyName("index")] ulong Index)
      : RevisionAnchor;

  /// <summary>
  /// Presentation slide, identified by its zero-based index.
  /// </summary>
  public sealed record Slide([property : JsonPropertyName("index")] ulong Index)
      : RevisionAnchor;
...
/// <summary>
/// Custom converter for RevisionAnchor sealed union with flattened variant
/// fields.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class RevisionAnchorJsonConverter
    : JsonConverter<RevisionAnchor> {
  public override RevisionAnchor Read(ref Utf8JsonReader reader,
                                      Type typeToConvert,
    ...
    return tagValue switch {
      "paragraph" => JsonSerializer.Deserialize<RevisionAnchor.Paragraph>(
                         flatJson, options) ??
                     throw new JsonException("Failed to deserialize variant"),
      "table_cell" => JsonSerializer.Deserialize<RevisionAnchor.TableCell>(
                          flatJson, options) ??
                      throw new JsonException("Failed to deserialize variant"),
      "page" =>
          JsonSerializer.Deserialize<RevisionAnchor.Page>(flatJson, options) ??
          throw new JsonException("Failed to deserialize variant"),
      "slide" =>
          JsonSerializer.Deserialize<RevisionAnchor.Slide>(flatJson, options) ??
          throw new JsonException("Failed to deserialize variant"),
      "sheet" =>
          JsonSerializer.Deserialize<RevisionAnchor.Sheet>(flatJson, options) ??
          throw new JsonException("Failed to deserialize variant"),
      // Unknown discriminator: forward compatibility for unknown variants
      _ => throw new JsonException(
          $"Unknown RevisionAnchor discriminator: {tagValue}")
    };
  }

  public override void Write(Utf8JsonWriter writer, RevisionAnchor value,
                             JsonSerializerOptions options) {
    ...
    case RevisionAnchor.Paragraph v_paragraph:
      ...
      inner = v_paragraph;
      break;
    case RevisionAnchor.TableCell v_tablecell:
      tag = "table_cell";
      inner = v_tablecell;
      break;
    case RevisionAnchor.Page v_page:
      tag = "page";
      inner = v_page;
      break;
    case RevisionAnchor.Slide v_slide:
      tag = "slide";
      inner = v_slide;
      break;
    case RevisionAnchor.Sheet v_sheet:
      tag = "sheet";
      inner = v_sheet;
      break;
    default:
      throw new JsonException(
          $"Unknown RevisionAnchor variant: {value.GetType().Name}");
    }
