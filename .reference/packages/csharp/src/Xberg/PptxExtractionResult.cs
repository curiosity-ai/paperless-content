...
// alef:hash:f405440d3e3cc736ee9ce0040b44577ffdecb97a1ce3ff0e9dd3c8219fdc1d5b
...
public sealed record PptxExtractionResult {
  ...
  public List<PresentationHyperlink> Hyperlinks {
    get; init;
  } = [];
  ...
  public Dictionary<string, string> OfficeMetadata {
    get; init;
  ...
  public static PptxExtractionResult FromJson(string json) {
    try {
      return JsonSerializer.Deserialize<PptxExtractionResult>(json,
                                                              JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse PptxExtractionResult from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse PptxExtractionResult from JSON: {e.Message}", e);
    }
  }
