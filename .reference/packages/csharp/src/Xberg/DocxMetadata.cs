...
// alef:hash:f2c47f40d1b4d263dd1e5732ba148660376d85519ba85532d4c35d5b5898627d
    ...
    try {
      return JsonSerializer.Deserialize<DocxMetadata>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DocxMetadata from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DocxMetadata from JSON: {e.Message}", e);
    }
  }
