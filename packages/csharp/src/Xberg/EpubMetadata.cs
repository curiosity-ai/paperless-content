...
// alef:hash:68068e3cff7ceba73630139dc07653022c4bd442bf75eedaf54bf9690c86eb91
    ...
    try {
      return JsonSerializer.Deserialize<EpubMetadata>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse EpubMetadata from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse EpubMetadata from JSON: {e.Message}", e);
    }
  }
