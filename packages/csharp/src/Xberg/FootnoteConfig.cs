...
// alef:hash:4e24b6442b3bf2d356e6184bcdd335f02609d0747faeb0f5bf5251320034f723
...
public sealed record FootnoteConfig {
    ...
    try {
      return JsonSerializer.Deserialize<FootnoteConfig>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse FootnoteConfig from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse FootnoteConfig from JSON: {e.Message}", e);
    }
  }
  ...
  public static FootnoteConfig Default() {
    ...
    return JsonSerializer.Deserialize<FootnoteConfig>(json ?? "null",
                                                      JsonOptions)!;
  }
