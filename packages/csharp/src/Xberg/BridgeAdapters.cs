...
// alef:hash:9f6e028ee08bd571405d152f9861728593f3d99c6aff1159682a908fa1e12cd7
// To regenerate: alef generate
// To verify freshness: alef verify

// This file contains adapter bridges that wrap user trait implementations and
// delegate to the plugin interface.
#nullable enable
...
//
// Each adapter sealed class conforms to the bridge interface `I{TraitName}` by
// delegating to a user-provided implementation instance. The adapter exposes
// itself to the Rust side via P/Invoke as the handle parameter, allowing e2e
// tests and user code to register implementations.
//
...
// - _DocumentExtractorBridgeAdapter →
// "csharp-bridge-document_extractor-adapter"
...
//
// These names are used by e2e test cleanup to unregister adapters after each
// test.

/// <summary>
/// Adapter bridge for OcrBackend trait implementation.
/// Wraps a user-provided IOcrBackend implementation and delegates all method
/// calls.
/// </summary>
public sealed class _OcrBackendBridgeAdapter : IOcrBackend {
  private readonly IOcrBackend _impl;

  /// <summary>Create an adapter around a user-provided OcrBackend
  ...
  /// <summary></summary>
  public ConfidenceSemantics ConfidenceSemantics => _impl.ConfidenceSemantics;

  /// <summary></summary>
  public PageOrientationHandling PageOrientationHandling =>
      _impl.PageOrientationHandling;
...
/// Wraps a user-provided IPostProcessor implementation and delegates all method
/// calls.
/// </summary>
public sealed class _PostProcessorBridgeAdapter : IPostProcessor {
  private readonly IPostProcessor _impl;

  /// <summary>Create an adapter around a user-provided PostProcessor
  /// implementation.</summary>
...
/// Wraps a user-provided IValidator implementation and delegates all method
/// calls.
/// </summary>
public sealed class _ValidatorBridgeAdapter : IValidator {
  private readonly IValidator _impl;

  /// <summary>Create an adapter around a user-provided Validator
  /// implementation.</summary>
  ...
  /// <summary></summary>
  public bool ShouldValidate(ExtractedDocument Result,
...
/// Wraps a user-provided IDocumentExtractor implementation and delegates all
/// method calls.
/// </summary>
public sealed class _DocumentExtractorBridgeAdapter : IDocumentExtractor {
  private readonly IDocumentExtractor _impl;

  /// <summary>Create an adapter around a user-provided DocumentExtractor
  /// implementation.</summary>
  ...
  /// <summary></summary>
  public ExtractedDocument Extract(ExtractInput Input,
                                   ExtractionConfig Config) {
...
/// Wraps a user-provided IEmbeddingBackend implementation and delegates all
/// method calls.
/// </summary>
public sealed class _EmbeddingBackendBridgeAdapter : IEmbeddingBackend {
  private readonly IEmbeddingBackend _impl;

  /// <summary>Create an adapter around a user-provided EmbeddingBackend
  /// implementation.</summary>
...
/// Wraps a user-provided IRenderer implementation and delegates all method
/// calls.
/// </summary>
public sealed class _RendererBridgeAdapter : IRenderer {
  private readonly IRenderer _impl;

  /// <summary>Create an adapter around a user-provided Renderer
  /// implementation.</summary>
...
/// Wraps a user-provided IRerankerBackend implementation and delegates all
/// method calls.
/// </summary>
public sealed class _RerankerBackendBridgeAdapter : IRerankerBackend {
  private readonly IRerankerBackend _impl;

  /// <summary>Create an adapter around a user-provided RerankerBackend
  /// implementation.</summary>
...
/// Wraps a user-provided ITokenizerBackend implementation and delegates all
/// method calls.
/// </summary>
public sealed class _TokenizerBackendBridgeAdapter : ITokenizerBackend {
  private readonly ITokenizerBackend _impl;

  /// <summary>Create an adapter around a user-provided TokenizerBackend
  /// implementation.</summary>
  ...
  /// <summary></summary>
  public ulong CountTokens(string Text) { return _impl.CountTokens(Text); }
}
