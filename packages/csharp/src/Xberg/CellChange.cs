...
// alef:hash:42275e386b3d0f411eaf221292f353cfe7a018a93fd765cc0cf805c36f3097f7
    ...
    try {
      return JsonSerializer.Deserialize<CellChange>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse CellChange from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse CellChange from JSON: {e.Message}", e);
    }
  }
