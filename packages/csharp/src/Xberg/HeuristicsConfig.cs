...
// alef:hash:9f17f0b9474655ee5bd96d79000b715bb5c0eeacf98380fb8044614711fa56ec
...
/// struct-update syntax: `HeuristicsConfig { text_layer_threshold: 0.5,
/// ..Default.default() }`.
/// </summary>
public sealed record HeuristicsConfig {
  ...
  public float TextLayerThreshold {
    get; init;
  } = 0.7f;
  ...
  public ulong FileSizeThresholdBytes {
    get; init;
  } = 10485760;
  ...
  public uint PageCountThreshold {
    get; init;
  } = 50;
  ...
  public uint TargetPagesPerChunk {
    get; init;
  } = 10;
  ...
  public ulong DiskProcessingThresholdBytes {
    get; init;
  } = 52428800;
  ...
  public uint MaxXlsxSheetCount {
    get; init;
  } = 200;

  /// <summary>
  /// Maximum cell count (sheets × rows × columns approximation) in an XLSX
  /// workbook.
  ///
  /// Default: 5 000 000 (≈ 200 sheets × 25 k cells).
  /// </summary>
  [JsonPropertyName("max_xlsx_workbook_cells")]
  public ulong MaxXlsxWorkbookCells {
    get; init;
  } = 5000000;

  /// <summary>
  /// Maximum number of OLE-embedded objects extractable from a single PPTX or
  /// DOCX.
  ///
  /// Protects against zip-bomb-style nested-document abuse. Default: 50.
  /// </summary>
  [JsonPropertyName("max_pptx_embedded_count")]
  public uint MaxPptxEmbeddedCount {
    get; init;
  } = 50;
    ...
    try {
      return JsonSerializer.Deserialize<HeuristicsConfig>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse HeuristicsConfig from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse HeuristicsConfig from JSON: {e.Message}", e);
    }
  }
  ...
  public static HeuristicsConfig Default() {
    ...
    return JsonSerializer.Deserialize<HeuristicsConfig>(json ?? "null",
                                                        JsonOptions)!;
  }
}
