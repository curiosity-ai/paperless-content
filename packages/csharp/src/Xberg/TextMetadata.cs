...
// alef:hash:42315daf0d76968f45a1d64743ebb5c6eae68a7a4c5251b297bf495660992852
    ...
    try {
      return JsonSerializer.Deserialize<TextMetadata>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse TextMetadata from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse TextMetadata from JSON: {e.Message}", e);
    }
  }
