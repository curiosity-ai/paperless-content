...
// alef:hash:e2974f7d90f98231fd5338f8b0c3176532172fea5f3fb9fbccf691a1c541c0ee
    ...
    try {
      return JsonSerializer.Deserialize<DocxAppProperties>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DocxAppProperties from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DocxAppProperties from JSON: {e.Message}", e);
    }
  }
