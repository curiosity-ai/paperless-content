...
// alef:hash:163e38dcf9ac2687dec24e2b4f3fa6140206d5dd47be628c2dede2c78800924a
    ...
    try {
      return JsonSerializer.Deserialize<MultidocInput>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse MultidocInput from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse MultidocInput from JSON: {e.Message}", e);
    }
  }
