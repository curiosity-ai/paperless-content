...
// alef:hash:96d545e0d925e2eb84b31a2a5540b797af7391845fc3232e9adbdf22dbcdae03
    ...
    try {
      return JsonSerializer.Deserialize<LayoutDetection>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse LayoutDetection from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse LayoutDetection from JSON: {e.Message}", e);
    }
  }
