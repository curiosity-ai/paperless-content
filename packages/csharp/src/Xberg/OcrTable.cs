...
// alef:hash:01b824797b689c515259b3b6a32091131dac140d2f7eb94124c0891c5866982f
    ...
    try {
      return JsonSerializer.Deserialize<OcrTable>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse OcrTable from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse OcrTable from JSON: {e.Message}", e);
    }
  }
