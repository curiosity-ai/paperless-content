...
// alef:hash:1b04aea33fde93acfc2f00fe391af1483a23f066bc5fa07532fddf1c4d6fb01d
    ...
    try {
      return JsonSerializer.Deserialize<PptxMetadata>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse PptxMetadata from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse PptxMetadata from JSON: {e.Message}", e);
    }
  }
