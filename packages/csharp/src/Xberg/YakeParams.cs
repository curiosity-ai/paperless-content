...
// alef:hash:77e8d5458a2b42725f17f56602775df1c123a69a9d585bff9a9470a538108f72
    ...
    try {
      return JsonSerializer.Deserialize<YakeParams>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse YakeParams from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse YakeParams from JSON: {e.Message}", e);
    }
  }
