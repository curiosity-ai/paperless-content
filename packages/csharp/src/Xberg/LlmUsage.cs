...
// alef:hash:5f18bcf13784da201a1dfa1bcfcb592be88fd85233657c85007ef7f82c8cc383
...
public sealed record LlmUsage {
  /// <summary>
  /// The LLM model identifier (e.g. "openai/gpt-4o",
    ...
    try {
      return JsonSerializer.Deserialize<LlmUsage>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse LlmUsage from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse LlmUsage from JSON: {e.Message}", e);
    }
  }
