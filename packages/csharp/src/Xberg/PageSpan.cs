...
// alef:hash:89816520f8d1525bfacb5ecdfa32972609c7dff132864963acd02c8c3d358151
...
/// <summary>
/// A single page covered by a chunk, with an optional bounding box on that
/// page.
///
    ...
    try {
      return JsonSerializer.Deserialize<PageSpan>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse PageSpan from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse PageSpan from JSON: {e.Message}", e);
    }
  }
