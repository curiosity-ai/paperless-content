...
// alef:hash:17795741e84fb46cf6b2a9f02488022d159b01983b2ff433b9348483e60a73f9
    ...
    try {
      return JsonSerializer.Deserialize<DocumentMetadata>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DocumentMetadata from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DocumentMetadata from JSON: {e.Message}", e);
    }
  }
