...
// alef:hash:a366b6697eef9afb76331d166cc5ae10e847916545cd7c6d66189d448cc9fee3
...
public sealed record LateInteractionPreset {
  ...
  public required string ModelRepo {
    get; init;
  }
  ...
  public static LateInteractionPreset FromJson(string json) {
    try {
      return JsonSerializer.Deserialize<LateInteractionPreset>(json,
                                                               JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse LateInteractionPreset from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse LateInteractionPreset from JSON: {e.Message}", e);
    }
  }
