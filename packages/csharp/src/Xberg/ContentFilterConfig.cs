...
// alef:hash:4ed533530b69999b5d1956697ff7aabdcb0134ac0cc638ece20b2270f63308bc
...
public sealed record ContentFilterConfig {
  ...
  /// </summary>
  [JsonPropertyName("include_footnotes")]
  ...
  public bool StripRepeatingText {
    get; init;
  } = true;
  ...
  public static ContentFilterConfig FromJson(string json) {
    try {
      return JsonSerializer.Deserialize<ContentFilterConfig>(json,
                                                             JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ContentFilterConfig from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ContentFilterConfig from JSON: {e.Message}", e);
    }
  }
  ...
  public static ContentFilterConfig Default() {
    ...
    return JsonSerializer.Deserialize<ContentFilterConfig>(json ?? "null",
                                                           JsonOptions)!;
  }
}
