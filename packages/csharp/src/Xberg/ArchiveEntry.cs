...
// alef:hash:af3839f685c4cf49705771ec6f2860454ceeed5aaf2a04200cce252081733e6d
...
public sealed record ArchiveEntry {
  ...
  public ExtractedDocument Result {
    get; init;
    ...
    try {
      return JsonSerializer.Deserialize<ArchiveEntry>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ArchiveEntry from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ArchiveEntry from JSON: {e.Message}", e);
    }
  }
