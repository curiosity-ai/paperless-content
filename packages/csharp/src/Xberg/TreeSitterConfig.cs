...
// alef:hash:5a42f99a2f18484ddadd1defa495899b0dd0ca361fe64dcba02e72af7d95e514
...
public sealed record TreeSitterConfig {
    ...
    try {
      return JsonSerializer.Deserialize<TreeSitterConfig>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse TreeSitterConfig from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse TreeSitterConfig from JSON: {e.Message}", e);
    }
  }
  ...
  public static TreeSitterConfig Default() {
    ...
    return JsonSerializer.Deserialize<TreeSitterConfig>(json ?? "null",
                                                        JsonOptions)!;
  }
}
