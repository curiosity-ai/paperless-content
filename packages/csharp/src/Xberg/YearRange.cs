...
// alef:hash:4a86778b4b64de18bc121c52bc34f336ae013bfd33d7c0eff5a243f66e2630a5
    ...
    try {
      return JsonSerializer.Deserialize<YearRange>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse YearRange from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse YearRange from JSON: {e.Message}", e);
    }
  }
