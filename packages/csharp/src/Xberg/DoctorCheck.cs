...
// alef:hash:c215e84e1d81298d1c1ca5b577d238002ae86700768cddfa6cf8f93d7de7388c
...
public sealed record DoctorCheck {
  ...
  public required ProbeStatus Status {
    get; init;
  }
    ...
    try {
      return JsonSerializer.Deserialize<DoctorCheck>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DoctorCheck from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DoctorCheck from JSON: {e.Message}", e);
    }
  }
  ...
  public static DoctorCheck Pass(string name, string message) {
    ...
    return JsonSerializer.Deserialize<DoctorCheck>(json ?? "null",
                                                   JsonOptions)!;
  }
