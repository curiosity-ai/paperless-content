...
// alef:hash:26ed7b4c4a13d8e88ccb807391e71458f57e0c07bffa188da45f3b734917b68e
    ...
    try {
      return JsonSerializer.Deserialize<HeadingContext>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse HeadingContext from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse HeadingContext from JSON: {e.Message}", e);
    }
  }
