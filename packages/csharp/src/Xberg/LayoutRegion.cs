...
// alef:hash:b4207b7fa34b1f9cd5275ed80812aca5a7c29af05ecba4379a314f98168851ff
    ...
    try {
      return JsonSerializer.Deserialize<LayoutRegion>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse LayoutRegion from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse LayoutRegion from JSON: {e.Message}", e);
    }
  }
