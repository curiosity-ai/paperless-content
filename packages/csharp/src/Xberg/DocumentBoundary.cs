...
// alef:hash:890bf21de04e67014da27f5849aac47301846f119fa9217c7b2855ffbc255ef4
...
public sealed record DocumentBoundary {
  ...
  public required BoundaryReason Reason {
    get; init;
  }
    ...
    try {
      return JsonSerializer.Deserialize<DocumentBoundary>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DocumentBoundary from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DocumentBoundary from JSON: {e.Message}", e);
    }
  }
