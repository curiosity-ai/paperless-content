...
// alef:hash:df9535c10f87e3cc21fa786f073d05b1bbffcdd803bf8ebc751f7734a300fa25
    ...
    try {
      return JsonSerializer.Deserialize<ChunkInfo>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ChunkInfo from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ChunkInfo from JSON: {e.Message}", e);
    }
  }
