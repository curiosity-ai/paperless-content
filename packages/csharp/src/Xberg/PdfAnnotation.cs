...
// alef:hash:320e34f5ca11893764766c9a1bd0f7f635c45a84d7a157d93ed13296d157f5a5
    ...
    try {
      return JsonSerializer.Deserialize<PdfAnnotation>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse PdfAnnotation from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse PdfAnnotation from JSON: {e.Message}", e);
    }
  }
