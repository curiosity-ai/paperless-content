...
// alef:hash:d15b8b442119bde13119175704529fe1f286f46dba2229b59a21b3d4bc80d105
...
/// position.
///
/// Flat rather than a nested `Vec&lt;Vec&lt;Option&lt;..&gt;&gt;&gt;`: the
/// nested shape marshals badly across the FFI bindings, and the data is sparse
/// anyway. See `Table.cell_styles`.
/// </summary>
    ...
    try {
      return JsonSerializer.Deserialize<TableCellStyle>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse TableCellStyle from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse TableCellStyle from JSON: {e.Message}", e);
    }
  }
