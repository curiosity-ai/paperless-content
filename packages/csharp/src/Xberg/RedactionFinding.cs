...
// alef:hash:57fde6936e983afc92c1ab9e64b26e2a8bedd6c9b8152463c9343465d6fbbd14
...
public sealed record RedactionFinding {
  /// <summary>
  /// Byte-offset start in the original (pre-redaction)
  ...
  public required PiiCategory Category {
    get; init;
  }
  ...
  public required RedactionStrategy Strategy {
    get; init;
  }
  ...
  public required string ReplacementToken {
    get; init;
  }
    ...
    try {
      return JsonSerializer.Deserialize<RedactionFinding>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse RedactionFinding from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse RedactionFinding from JSON: {e.Message}", e);
    }
  }
