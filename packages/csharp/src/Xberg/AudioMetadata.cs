...
// alef:hash:230db49f517364dc1d8658e15182beab4cfc447171b23bbd06678ba80962b849
...
/// PCM decode properties. Available when the `transcription-types` feature is
/// enabled.
/// </summary>
    ...
    try {
      return JsonSerializer.Deserialize<AudioMetadata>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse AudioMetadata from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse AudioMetadata from JSON: {e.Message}", e);
    }
  }
