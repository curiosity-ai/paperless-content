...
// alef:hash:58f4000283972905504417e7171a04cf3e34035ceb92262a076b8c831f0f7685
...
public sealed record ExtractionResult {
  ...
  public List<ExtractionErrorItem> Errors {
    get; init;
  } = [];
  ...
  public ExtractionSummary Summary {
    get; init;
  ...
  public List<string> CrawlFinalUrls {
    get; init;
  } = [];
  ...
  public ulong CrawlRedirectCount {
    get; init;
  } = 0;
  ...
  public List<string> CrawlUniqueNormalizedUrls {
    get; init;
  } = [];
    ...
    try {
      return JsonSerializer.Deserialize<ExtractionResult>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse ExtractionResult from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse ExtractionResult from JSON: {e.Message}", e);
    }
  }
