...
// alef:hash:4f5186197043ac213229a6e9118a5829ba616f863bb3e704a0627c673e98f77d
    ...
    try {
      return JsonSerializer.Deserialize<BoundingBox>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse BoundingBox from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse BoundingBox from JSON: {e.Message}", e);
    }
  }
