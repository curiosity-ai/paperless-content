...
// alef:hash:e006daf3cde7558caedfb5597838060686d2239a3e4375095ef710aad4c248f9
...
public sealed record DocumentRevision {
  ...
  public required RevisionKind Kind {
    get; init;
  }
    ...
    try {
      return JsonSerializer.Deserialize<DocumentRevision>(json, JsonOptions) ??
             throw new XbergException(
                 $"Failed to parse DocumentRevision from JSON: deserializer returned null");
    } catch (XbergException) {
      throw;
    } catch (Exception e) {
      throw new XbergException(
          $"Failed to parse DocumentRevision from JSON: {e.Message}", e);
    }
  }
