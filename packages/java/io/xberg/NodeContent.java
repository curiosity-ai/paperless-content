...
// alef:hash:bba30f98f720b405273f1c38103040de56574ed533000b44a716c3edafe57049
...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = NodeContent.Comment.class, name = "comment"),
...
public sealed interface NodeContent {
     ...
     */
    record Comment(@JsonProperty("text") String text) implements NodeContent { }

    /**
     * Logical grouping container (section, key-value area).
     *
     * {@code heading_level} + {@code heading_text} capture the section heading directly
     ...
     */
    record MetadataBlock(@JsonProperty("entries") java.util.List<KeyValueAttribute> entries) implements NodeContent { }
}
