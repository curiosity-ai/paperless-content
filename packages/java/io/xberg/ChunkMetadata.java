...
// alef:hash:c225e08e8d52a0463a122e4990da3729c1f3a9d916ef8dce43a6d23e680a4f48
...
public record ChunkMetadata(
    ...
    @JsonProperty("page_spans") List<PageSpan> pageSpans,
    @JsonProperty("classifications") List<ClassificationLabel> classifications
) {
    ...
    public ChunkMetadata{
        ...
        if (nodeIds == null) { nodeIds = List.of(); }
        if (pageSpans == null) { pageSpans = List.of(); }
    ...
    public static final class Builder {
        ...
        @Nullable private List<String> headingPath = List.of();
        @JsonProperty("image_indices")
        @Nullable private List<Integer> imageIndices = List.of();
        @JsonProperty("node_ids")
        @Nullable private List<String> nodeIds = List.of();
        @JsonProperty("page_spans")
        @Nullable private List<PageSpan> pageSpans = List.of();
        @Nullable private List<ClassificationLabel> classifications = List.of();
