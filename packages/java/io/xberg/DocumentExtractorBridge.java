...
// alef:hash:c0874b9f2ea2eee4ac92adb6c2b99a754e3338f8a03700ff6030a5100a31830f
...
public final class DocumentExtractorBridge implements AutoCloseable {
    ...
    private static final System.Logger LOGGER = System.getLogger(DocumentExtractorBridge.class.getName());
    ...
    private long handleCanHandle(MemorySegment userData, MemorySegment _path_in, MemorySegment _mime_type_in) {
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING,
                "host 'can_handle' threw; returning default", e);
            return 0L;
        }
    }
