...
// alef:hash:28290bf304ee6354fd774f79efd6a8a4d32410dfc1111a0fe124c902c5f00f2c
...
public record TokenReductionConfig(
    ...
    public TokenReductionConfig{
        if (preserveCode == null) { preserveCode = true; }
        if (semanticThreshold == null) { semanticThreshold = 0.3f; }
        if (enableParallel == null) { enableParallel = true; }
        if (useSimd == null) { useSimd = true; }
