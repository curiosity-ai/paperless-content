...
// alef:hash:661f3a3ab5d2ab67f5a23d797622a8b469bdd0eb8ecec73738d98a24fbddc744
...
public sealed interface FormatMetadata {
     ...
     * the chunking pipeline to emit structure-aware {@code Chunk}s instead of falling back to
     * text-based splitting.
     *
     * Wraps CodeMetadata (a named struct) rather than {@code Vec&lt;CodeChunkInfo&gt;} directly:
     * {@code FormatMetadata} is internally tagged ({@code #[serde(tag = "format_type")]}), and serde
...
class FormatMetadataDeserializer extends StdDeserializer<FormatMetadata> {
  ...
  public FormatMetadata deserialize(final JsonParser parser, final DeserializationContext ctx)
      throws java.io.IOException {
    final ObjectNode node = parser.getCodec().readTree(parser);
    final com.fasterxml.jackson.databind.JsonNode tagNode = node.get("format_type");
    ...
    return switch (tagValue) {
      ...
      case "code" -> new FormatMetadata.Code(ctx.readTreeAsValue(node, CodeMetadata.class));
      default -> {
        throw new com.fasterxml.jackson.databind.JsonMappingException(
...
class FormatMetadataSerializer extends StdSerializer<FormatMetadata> {
  ...
  public void serialize(FormatMetadata value, JsonGenerator gen, SerializerProvider provider)
    ...
    Object inner;if (value instanceof FormatMetadata.Pdf variantPdf) {
      ...
      tag = "code";      inner = variantCode.value();    }    else {
      throw new com.fasterxml.jackson.databind.JsonMappingException(
