...
# alef:hash:c41069561092e184db72c5b24a3433a3178f5cf6ba768a4c8f73d3680e28a05b
# To regenerate: alef generate
# To verify freshness: alef verify

defmodule XbergValidatorBridge do
  @moduledoc """
  GenServer bridge for Validator implementation in xberg.
  ...
  impl_module should be a module that implements the Validator trait methods.
  """
  ...
  def register(impl_module) do
    ...
    Xberg.Native.register_validator(pid, plugin_name, implemented_methods)
  end
end
