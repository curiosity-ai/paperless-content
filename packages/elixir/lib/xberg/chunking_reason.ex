...
# alef:hash:5ddf81f061995f7be86c4f70ec86a857ef796e130b1e20a77254a34e4a7616f4
...
defmodule Xberg.ChunkingReason do
  ...
  def wire_value(:large_file), do: "LargeFile"
  def wire_value(:many_pages), do: "ManyPages"
  def wire_value(:ocr_required), do: "OcrRequired"
  def wire_value(:large_and_many_pages), do: "LargeAndManyPages"
