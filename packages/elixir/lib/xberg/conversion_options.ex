...
# alef:hash:748847706906e6c867bd0922ebadb22d5007d83cf8a3f07490dc4deccab6e722
...
defmodule Xberg.ConversionOptions do
  ...
  @type t :: %__MODULE__{
          heading_style: Xberg.HeadingStyle.t(),
          list_indent_type: Xberg.ListIndentType.t(),
          ...
          highlight_style: Xberg.HighlightStyle.t(),
          extract_metadata: boolean(),
          whitespace_mode: Xberg.WhitespaceMode.t(),
          ...
          newline_style: Xberg.NewlineStyle.t(),
          code_block_style: Xberg.CodeBlockStyle.t(),
          ...
          skip_images: boolean(),
          url_escape_style: Xberg.UrlEscapeStyle.t(),
          link_style: Xberg.LinkStyle.t(),
          output_format: Xberg.HtmlToMarkdownRsOutputFormat.t(),
          ...
          tier_strategy: Xberg.TierStrategy.t()
        }
