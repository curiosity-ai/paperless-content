...
# alef:hash:9e0e063a878e6ab71819f12c9a24d96c634886c34c798890fed841f564f80c42
# To regenerate: alef generate
# To verify freshness: alef verify

defmodule XbergPostProcessorBridge do
  @moduledoc """
  GenServer bridge for PostProcessor implementation in xberg.
  ...
  impl_module should be a module that implements the PostProcessor trait methods.
  """
  ...
  def register(impl_module) do
    ...
    Xberg.Native.register_post_processor(pid, plugin_name, implemented_methods)
  end
end
