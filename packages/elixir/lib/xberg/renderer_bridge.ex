...
# alef:hash:3a4e441549e6bc49020df1e8dc6306e10dd0fd39ac9f578d4a9d08f2611aa731
# To regenerate: alef generate
# To verify freshness: alef verify

defmodule XbergRendererBridge do
  @moduledoc """
  GenServer bridge for Renderer implementation in xberg.
  ...
  impl_module should be a module that implements the Renderer trait methods.
  """
  ...
  def register(impl_module) do
    ...
    Xberg.Native.register_renderer(pid, plugin_name, implemented_methods)
  end
end
