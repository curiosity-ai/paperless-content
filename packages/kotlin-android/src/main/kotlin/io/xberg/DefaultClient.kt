...
// alef:hash:d8802e6edcc3278a883503e478313832c8512eb0f78cd09459cdbefefc969f1c
@file:Suppress(
...
class Registry internal constructor(handle: Long) : AutoCloseable {
    ...
    fun get(id: String): Preset? {
        ...
        return if (responseJson == null) null else MAPPER.readValue(responseJson, Preset::class.java)
    }
