...
// alef:hash:5ea47cfe85f8a7af6ad37939b83b261401c796fc88751f1cae9250c9590dc0b2
...
/**
 * JSON dispatch wrapper for [ITokenizerBackend] implementations, called from the
 ...
 * opens up instead.
 */
class TokenizerBackendJniDispatcher(private val impl: ITokenizerBackend) {
    ...
    fun dispatch(method: String, argsJson: String): String =
        try {
            ...
            val result: Any? =
                when (method) {
                    "count_tokens" -> impl.countTokens(mapper.convertValue(args.get("text"), object : com.fasterxml.jackson.core.type.TypeReference<String>() {}))
                    "name" -> impl.name()
