...
// alef:hash:9786c1931da533d75d3656c88e8ce54d7754f4f6ee988d5232b71088bdc4e70e
@file:Suppress(
...
sealed class FormatMetadata {
     ...
     *
     * Wraps `CodeMetadata` (a named struct) rather than `List<CodeChunkInfo>` directly:
     ...
     */
    data class Code(val metadata: CodeMetadata) : FormatMetadata()
}
...
private class FormatMetadataDeserializer : com.fasterxml.jackson.databind.deser.std.StdDeserializer<FormatMetadata>(FormatMetadata::class.java) {
    ...
    override fun deserialize(
        ...
        return when (tag) {
            ...
            "code" -> FormatMetadata.Code(ctx.readTreeAsValue<CodeMetadata>(payload, CodeMetadata::class.java))
