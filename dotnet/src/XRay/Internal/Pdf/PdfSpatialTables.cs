...
using System.Linq;
using System.Text;
using XRay.Internal.PdfOxide;
using XRay.Internal.PdfOxide.Layout;
using XRay.Types;

namespace XRay.Internal.Pdf;
...
internal static partial class PdfSpatialTables
{
    ...
    /// <see cref="XRay.Internal.PdfOxide.Layout.OxPageOrder.PageReadingOrder"/> — so the
    ...
    private static List<GridTable> ConsolidateAdjacentTableFragments(List<GridTable> tables)
    {
        ...
        XRay.Internal.PdfOxide.Layout.OxSpanCompare.SortStable(sorted, (a, b) =>
        {
    ...
    private static string ExtractCellText(List<int> cellSpanIndices, List<TableSpan> spans)
    {
        ...
        XRay.Internal.PdfOxide.Layout.OxSpanCompare.SortStable(entries, (a, b) => SafeCmp(b.Y, a.Y));
