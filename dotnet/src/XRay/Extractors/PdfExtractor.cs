...
//
// Backend lives under XRay.Internal.Pdf (xref/trailer, objects, streams + filters,
...
public sealed class PdfExtractor : IExtractor
{
    ...
    public InternalDocument Extract(ReadOnlySpan<byte> content, string mimeType, ExtractionConfig config)
    {
        ...
        var tables = new List<XRay.Types.Table>();
        ...
        doc.Metadata = new Metadata
        {
            ...
            {
                FormatType = "pdf",
                Payload = new XRay.Types.PdfMetadata
                {
    ...
    /// </summary>
    private static List<XRay.Types.Table> ExtractRuledTables(
    ...
    internal static void AttachUnrepresentedTables(InternalDocument doc, List<XRay.Types.Table> tables)
    {
    ...
    /// </remarks>
    internal static bool TableIsRepresented(XRay.Types.Table table, Dictionary<string, int> represented)
    {
        ...
        for (int i = 0; i < pageCount; i++)
        {
            ...
            try
            {
                ...
                if (contentBytes.Length != 0)
                {
                    ...
                    List<XRay.Internal.PdfOxide.OxTextSpan>? structureSpans = null;
                    List<XRay.Internal.PdfOxide.OxTextSpan>? wordSpans = null;
                    ...
                    if (options.UsePortedPdfSpans)
                    {
                        ...
                        var oxResult = XRay.Internal.PdfOxide.Text.OxPageExtractor.ExtractPage(pdf, i);
                        var oxPage = oxResult.Text;
                        var oxSpans = oxPage.Spans;
                        wordSpans = oxResult.WordSpans;
                        var assembly = XRay.Internal.PdfOxide.Text.OxPageAssembler.Assemble(
