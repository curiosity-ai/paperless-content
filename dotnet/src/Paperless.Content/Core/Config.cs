...
public sealed class ExtractionConfig
{
    ...
    /// setting it selects <see cref="Paperless.Content.Rendering.StyledHtmlRenderer"/>.
    /// </summary>
    ...
    /// <see cref="ContentOptions.Default"/>. Not part of the wire format: everything above mirrors
    /// upstream's config field for field, and these have no upstream counterpart.
    /// </summary>
    [JsonIgnore]
    public ContentOptions Options { get; set; } = ContentOptions.Default;
}
