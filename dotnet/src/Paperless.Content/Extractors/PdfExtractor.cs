...
//
// Backend lives under Paperless.Content.Internal.Pdf (xref/trailer, objects, streams + filters,
...
public sealed class PdfExtractor : IExtractor
{
    ...
    public InternalDocument Extract(ReadOnlySpan<byte> content, string mimeType, ExtractionConfig config)
    {
        ...
        var tables = new List<Paperless.Content.Types.Table>();
        ...
        doc.Metadata = new Metadata
        {
            ...
            {
                FormatType = "pdf",
                Payload = new Paperless.Content.Types.PdfMetadata
                {
    ...
    /// </summary>
    private static List<Paperless.Content.Types.Table> ExtractRuledTables(
    ...
    internal static void AttachUnrepresentedTables(InternalDocument doc, List<Paperless.Content.Types.Table> tables)
    {
    ...
    /// </remarks>
    internal static bool TableIsRepresented(Paperless.Content.Types.Table table, Dictionary<string, int> represented)
    {
    ...
    private static string ExtractTextAndSegments(
        PdfDocument pdf, long deadline, ContentOptions options,
        ...
        for (int i = 0; i < pageCount; i++)
        {
            ...
            try
            {
                ...
                if (contentBytes.Length != 0)
                {
                    ...
                    List<Paperless.Content.Internal.PdfOxide.OxTextSpan>? structureSpans = null;
                    List<Paperless.Content.Internal.PdfOxide.OxTextSpan>? wordSpans = null;
                    ...
                    if (options.UsePortedPdfSpans)
                    {
                        ...
                        var oxResult = Paperless.Content.Internal.PdfOxide.Text.OxPageExtractor.ExtractPage(pdf, i);
                        var oxPage = oxResult.Text;
                        var oxSpans = oxPage.Spans;
                        wordSpans = oxResult.WordSpans;
                        var assembly = Paperless.Content.Internal.PdfOxide.Text.OxPageAssembler.Assemble(
