...
/// <summary>
/// Character mappings from WordPerfect's own character sets to Unicode.
/// </summary>
/// <remarks>
/// <para>
/// WordPerfect predates Unicode and encodes everything past ASCII through numbered character
/// sets, so a document's bytes mean nothing without these. The tables are generated from
/// libwpd's, which credits Ariya Hidayat's work for the KWord project.
/// </para>
/// <para>
/// Most sets map one byte to one scalar. A few map to a sequence — a combining accent followed by
/// its base letter — which is why the lookup returns a string rather than a scalar.
/// </para>
/// <para>
/// The Japanese sets are the one gap: libwpd carries a 31,936-entry Shift-JIS table for them,
/// which would be a quarter of a megabyte of generated source for a script none of the corpus
/// exercises. A Japanese WordPerfect document will lose those characters rather than mis-render
/// them.
/// </para>
/// </remarks>
internal static class WpCharacterMap
{
    private static readonly uint[] MultinationalWP6 =
    {
        ...
        0x0141, 0x0142, 0x0143, 0x0144, 0x0000, 0x0149, 0x0147, 0x0148,
        ...
        0x017b, 0x017c, 0x014a, 0x014b, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x1ef2, 0x1ef3, 0x010e, 0x010f, 0x01a0, 0x01a1,
        0x01af, 0x01b0, 0x0114, 0x0115, 0x012c, 0x012d, 0x0049, 0x0131,
        0x014e, 0x014f,
    };

    private static readonly uint[] PhoneticWP6 =
    {
    ...
    private static readonly uint[] BoxdrawingWP6 =
    {
    ...
    private static readonly uint[] TypographicWP6 =
    {
    ...
    private static readonly uint[] IconicWP6 =
    {
    ...
    private static readonly uint[] MathWP6 =
    {
        ...
        0x2297, 0x2295, 0x2296, 0x2a38, 0x2299, 0x2227, 0x2228, 0x22bb,
        0x22a4, 0x22a5, 0x2312, 0x22a2, 0x22a3, 0x25a1, 0x25a0, 0x25ca,
        0x25c6, 0x27e6, 0x27e7, 0x2260, 0x2262, 0x2235, 0x2234, 0x2237,
        0x222e, 0x2112, 0x212d, 0x2128, 0x2118, 0x20dd, 0x29cb, 0x25c7,
        ...
        0x2252, 0x2253, 0x224e, 0x224d, 0x22a8, 0x2258, 0x226c, 0x0285,
        ...
        0x2204, 0x2209, 0x2247, 0x2130, 0x2131, 0x2102, 0x0020, 0x2115,
        0x211d, 0x225f, 0x22be, 0x220b, 0x22ef, 0x2026, 0x22ee, 0x22f1,
        0x0020, 0x20e1, 0x002b, 0x002d, 0x003d, 0x002a, 0x2032, 0x2033,
        0x2034, 0x210b, 0x2118, 0x2272, 0x2273, 0x0020,
    };

    private static readonly uint[] MathextWP6 =
    {
    ...
    private static readonly uint[] GreekWP6 =
    {
    ...
    private static readonly uint[] HebrewWP6 =
    {
    ...
    private static readonly uint[] CyrillicWP6 =
    {
    ...
    private static readonly uint[] JapaneseWP6 =
    {
    ...
    private static readonly uint[] ArabicWP6 =
    {
        0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020,
    ...
    private static readonly uint[] ArabicScriptWP6 =
    {
    ...
    private static readonly uint[] International2WP5 =
    {
    ...
    private static readonly uint[] IconicWP5 =
    {
    ...
    private static readonly uint[] GreekWP5 =
    {
        0x0391, 0x03b1, 0x0392, 0x03b2, 0x0392, 0x03d0, 0x0393, 0x03b3,
        0x0394, 0x03b4, 0x0395, 0x03b5, 0x0396, 0x03b6, 0x0397, 0x03b7,
        0x0398, 0x03b8, 0x0399, 0x03b9, 0x039a, 0x03ba, 0x039b, 0x03bb,
    ...
    private static readonly uint[] HebrewWP5 =
    {
        0x05d0, 0x05d1, 0x05d2, 0x05d3, 0x05d4, 0x05d5, 0x05d6, 0x05d7,
        0x05d8, 0x05d9, 0x05da, 0x05db, 0x05dc, 0x05dd, 0x05de, 0x05df,
        0x05e0, 0x05e1, 0x05e2, 0x05e3, 0x05e4, 0x05e5, 0x05e6, 0x05e7,
    ...
    private static readonly uint[] CyrillicWP5 =
    {
        0x0410, 0x0430, 0x0411, 0x0431, 0x0412, 0x0432, 0x0413, 0x0433,
        0x0414, 0x0434, 0x0415, 0x0435, 0x0401, 0x0451, 0x0416, 0x0436,
        0x0417, 0x0437, 0x0418, 0x0438, 0x0419, 0x0439, 0x041a, 0x043a,
    ...
    private static readonly uint[] JapaneseWP5 =
    {
    ...
    private static readonly uint[] ArabicWP5 =
    {
        0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020,
        0x0020, 0x0020, 0x064e, 0xfe77, 0x064f, 0xfe79, 0x0650, 0xfe7b,
        0x064b, 0x064c, 0x064c, 0x064d, 0x0652, 0xfe7f, 0x0651, 0xfe7d,
    ...
    private static readonly uint[] ArabicScriptWP5 =
    {
        0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0615,
        0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020,
        0x0615, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020, 0x0020,
    ...
    private static readonly uint[] ExtendedCharactersWP42 =
    {
        ...
        0x00c7, 0x00fc, 0x00eb, 0x00e2, 0x00e4, 0x00e0, 0x00e5, 0x00e7,
        0x00ea, 0x00eb, 0x00e8, 0x00ef, 0x00ee, 0x00ec, 0x00c4, 0x00c5,
        0x00c9, 0x00e6, 0x00c6, 0x00f4, 0x00f6, 0x00f2, 0x00fb, 0x00f9,
        0x00ff, 0x00d6, 0x00dc, 0x00a2, 0x00a3, 0x00a5, 0x20a7, 0x0192,
        0x00e1, 0x00ed, 0x00f3, 0x00f4, 0x00f1, 0x00d1, 0x00aa, 0x00ba,
        ...
        0x03a6, 0x0398, 0x03a9, 0x03b4, 0x221e, 0x03c6, 0x03b5, 0x22c2,
        0x2261, 0x00b1, 0x2265, 0x2264, 0x2320, 0x2321, 0x00f7, 0x2248,
        0x00b0, 0x2022, 0x22c5, 0x221a, 0x207f, 0x00b2, 0x25fc, 0x0020,
    };

    private static readonly Dictionary<int, int[]> MultinationalWP6Complex = new()
    {
        [156] = new[] { 0x02bc, 0x004e },
        [212] = new[] { 0x0304, 0x0044 },
        [213] = new[] { 0x0304, 0x0064 },
        [214] = new[] { 0x0304, 0x004c },
        [215] = new[] { 0x0304, 0x006c },
        [216] = new[] { 0x0304, 0x004e },
        [217] = new[] { 0x0304, 0x006e },
        [218] = new[] { 0x0300, 0x0052 },
        [219] = new[] { 0x0300, 0x0072 },
        [220] = new[] { 0x0304, 0x0053 },
        [221] = new[] { 0x0304, 0x0073 },
        [222] = new[] { 0x0304, 0x0054 },
        [223] = new[] { 0x0304, 0x0074 },
        [224] = new[] { 0x0306, 0x0059 },
        [225] = new[] { 0x0306, 0x0079 },
    };

    private static readonly Dictionary<int, int[]> CyrillicWP5Complex = new()
    {
        [110] = new[] { 0x0410, 0x0301 },
        [111] = new[] { 0x0430, 0x0301 },
        [112] = new[] { 0x0415, 0x0301 },
        [113] = new[] { 0x0435, 0x0301 },
        [114] = new[] { 0x0418, 0x0301 },
        [115] = new[] { 0x0458, 0x0301 },
        [116] = new[] { 0x041e, 0x0301 },
        [117] = new[] { 0x043e, 0x0301 },
        [118] = new[] { 0x0423, 0x0301 },
        [119] = new[] { 0x0443, 0x0301 },
        [120] = new[] { 0x042b, 0x0301 },
        [121] = new[] { 0x044b, 0x0301 },
        [122] = new[] { 0x042d, 0x0301 },
        [123] = new[] { 0x044d, 0x0301 },
        [124] = new[] { 0x042e, 0x0301 },
        [125] = new[] { 0x044e, 0x0301 },
        [126] = new[] { 0x042f, 0x0301 },
        [127] = new[] { 0x044f, 0x0301 },
        [128] = new[] { 0x0410, 0x0300 },
        [129] = new[] { 0x0430, 0x0300 },
        [132] = new[] { 0x0401, 0x0300 },
        [133] = new[] { 0x0451, 0x0300 },
        [136] = new[] { 0x041e, 0x0300 },
        [137] = new[] { 0x043e, 0x0300 },
        [138] = new[] { 0x0423, 0x0300 },
        [139] = new[] { 0x0443, 0x0300 },
        [140] = new[] { 0x042b, 0x0300 },
        [141] = new[] { 0x044b, 0x0300 },
        [142] = new[] { 0x042d, 0x0300 },
        [143] = new[] { 0x044d, 0x0300 },
        [144] = new[] { 0x042e, 0x0300 },
        [145] = new[] { 0x044e, 0x0300 },
        [146] = new[] { 0x042f, 0x0300 },
        [147] = new[] { 0x044f, 0x0300 },
    };

    private static readonly Dictionary<int, int[]> ArabicWP5Complex = new()
    {
        [25] = new[] { 0x0640, 0xfc60 },
        [27] = new[] { 0x0640, 0xfc61 },
        [29] = new[] { 0x0640, 0xfc62 },
        [30] = new[] { 0x064b, 0x0651 },
        [35] = new[] { 0x0640, 0x0670 },
        [178] = new[] { 0xfefb, 0x064b },
        [179] = new[] { 0xfefc, 0x064b },
        [182] = new[] { 0xfefb, 0x02c6 },
        [183] = new[] { 0xfefc, 0x02c6 },
    };
    /// <summary>
    /// The Mac Roman character set, indexed from 0x20.
    /// </summary>
    /// <remarks>
    /// Macintosh WordPerfect writes its own Mac Roman byte alongside a WordPerfect character-set
    /// pair, and prefers the Mac one where it has a value — which is what WordPerfect 3.x for Mac
    /// itself does.
    /// </remarks>
    private static readonly uint[] MacRoman =
    {
        0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027,
        0x0028, 0x0029, 0x002a, 0x002b, 0x002c, 0x002d, 0x002e, 0x002f,
        0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037,
    ...
    /// <summary>The text for a Mac Roman byte at or above 0x20.</summary>
    public static string MacRomanCharacter(byte character) =>
        character >= 0x20 && character - 0x20 < MacRoman.Length
            ? char.ConvertFromUtf32((int)MacRoman[character - 0x20])
            : " ";

    /// <summary>Look up a byte in a simple one-to-one table, or <c>null</c> when unmapped.</summary>
    private static string? Simple(uint[] table, byte character) =>
        character < table.Length && table[character] != 0
            ? char.ConvertFromUtf32((int)table[character])
            : null;

    /// <summary>Look up a byte that maps to a sequence of scalars.</summary>
    private static string? Complex(Dictionary<int, int[]> table, byte character) =>
        table.TryGetValue(character, out var scalars)
            ? string.Concat(scalars.Select(char.ConvertFromUtf32))
            : null;

    /// <summary>
    /// The text for a WordPerfect 4.2 extended character; a space when the byte maps to nothing.
    /// </summary>
    public static string Wp42Extended(byte character) =>
        Simple(ExtendedCharactersWP42, character) ?? " ";

    /// <summary>
    /// The text for a WordPerfect 5.x extended character in the named character set.
    /// </summary>
    /// <remarks>
    /// Set 0 is plain ASCII — undocumented, but what libwpd does, and different from how the
    /// document body treats the same byte values.
    /// </remarks>
    public static string Wp5Extended(byte character, byte characterSet)
    {
        if (characterSet == 0)
            return character >= 0x20 && character < 0x7F ? ((char)character).ToString() : " ";

        return characterSet switch
        {
            1 => Simple(MultinationalWP6, character) ?? Complex(MultinationalWP6Complex, character),
            2 => Simple(International2WP5, character),
            3 => Simple(BoxdrawingWP6, character),
            4 => Simple(TypographicWP6, character),
            5 => Simple(IconicWP5, character),
            6 => Simple(MathWP6, character),
            7 => Simple(MathextWP6, character),
            8 => Simple(GreekWP5, character),
            9 => Simple(HebrewWP5, character),
            10 => Simple(CyrillicWP5, character) ?? Complex(CyrillicWP5Complex, character),
            11 => Simple(JapaneseWP5, character),
            13 => Simple(ArabicWP5, character) ?? Complex(ArabicWP5Complex, character),
            14 => Simple(ArabicScriptWP5, character),
            _ => null,
        } ?? " ";
    }

    /// <summary>
    /// The text for a WordPerfect 6.x extended character in the named character set.
    /// </summary>
    public static string Wp6Extended(byte character, byte characterSet)
    {
        if (characterSet == 0)
            return character >= 0x20 && character < 0x7F ? ((char)character).ToString() : " ";
        ...
        {
            1 => Simple(MultinationalWP6, character) ?? Complex(MultinationalWP6Complex, character),
            2 => Simple(PhoneticWP6, character),
            3 => Simple(BoxdrawingWP6, character),
            4 => Simple(TypographicWP6, character),
            5 => Simple(IconicWP6, character),
            6 => Simple(MathWP6, character),
            7 => Simple(MathextWP6, character),
            8 => Simple(GreekWP6, character),
            9 => Simple(HebrewWP6, character),
            10 => Simple(CyrillicWP6, character),
            11 => Simple(JapaneseWP6, character),
            13 => Simple(ArabicWP6, character),
            14 => Simple(ArabicScriptWP6, character),
            _ => null,
        } ?? " ";
    }
}
