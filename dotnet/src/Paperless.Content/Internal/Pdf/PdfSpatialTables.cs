...
internal static partial class PdfSpatialTables
{
    ...
    /// <see cref="Paperless.Content.Internal.PdfOxide.Layout.OxPageOrder.PageReadingOrder"/> — so the
    ...
    private static List<GridTable> ConsolidateAdjacentTableFragments(List<GridTable> tables)
    {
        ...
        Paperless.Content.Internal.PdfOxide.Layout.OxSpanCompare.SortStable(sorted, (a, b) =>
        {
    ...
    private static string ExtractCellText(List<int> cellSpanIndices, List<TableSpan> spans)
    {
        ...
        Paperless.Content.Internal.PdfOxide.Layout.OxSpanCompare.SortStable(entries, (a, b) => SafeCmp(b.Y, a.Y));
