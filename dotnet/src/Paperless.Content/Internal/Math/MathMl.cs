...
// The namespace deliberately differs from the directory name: a `Paperless.Content.Internal.Math` namespace
// would shadow `System.Math` for every file under `Paperless.Content.Internal.*`.
namespace Paperless.Content.Internal.MathMarkup;
