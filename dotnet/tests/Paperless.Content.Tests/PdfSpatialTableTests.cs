...
using Paperless.Content.Internal.PdfOxide.Text;
using Xunit;
...
public class PdfSpatialTableTests
{
    ...
    private static Paperless.Content.Internal.PdfOxide.OxTextSpan OxSpan(
        string text, float x, float y, float width, float rotation) =>
        new()
        {
            Text = text,
            Bbox = new Paperless.Content.Internal.PdfOxide.OxRect(x, y, width, 10.0f),
            FontSize = 10.0f,
    ...
    {
        var spans = new List<Paperless.Content.Internal.PdfOxide.OxTextSpan>
        {
    ...
    public void RotatedContentOnARotatedPageIsMappedIntoTheDisplayedFrame()
    {
        ...
        span.Bbox = new Paperless.Content.Internal.PdfOxide.OxRect(59.57f, 166.21f, 53.34f, 7.5f);
    ...
    private static List<Paperless.Content.Internal.PdfOxide.OxTextSpan> Clone(
        List<Paperless.Content.Internal.PdfOxide.OxTextSpan> spans)
    {
        var copy = new List<Paperless.Content.Internal.PdfOxide.OxTextSpan>(spans.Count);
