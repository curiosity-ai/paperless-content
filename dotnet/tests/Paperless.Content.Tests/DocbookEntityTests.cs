...
public class DocbookEntityTests
{
    ...
    public void AListAfterAVariableListIsStillAList()
    {
        ...
        Assert.Contains(Paperless.Content.Types.ElementKindTag.DefinitionTerm, kinds);
        Assert.Equal(2, kinds.Count(k => k == Paperless.Content.Types.ElementKindTag.ListItem));
        Assert.DoesNotContain(Paperless.Content.Types.ElementKindTag.DefinitionDescription, kinds.Skip(kinds.IndexOf(Paperless.Content.Types.ElementKindTag.ListItem)));
    }
}
