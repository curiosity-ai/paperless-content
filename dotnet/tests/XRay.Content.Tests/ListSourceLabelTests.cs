...
public sealed class ListSourceLabelTests
{
    ...
    {
        string html = new StyledHtmlRenderer(new XRay.Content.Core.HtmlOutputConfig())
    ...
    public void AParenthesizedQuantityClarificationIsNotAListItem(string line) =>
        Assert.False(XRay.Content.Internal.Pdf.PdfStructure.LooksLikeListItem(line));
    ...
    public void GenuineParenthesizedMarkersRemainListItems(string line) =>
        Assert.True(XRay.Content.Internal.Pdf.PdfStructure.LooksLikeListItem(line));
