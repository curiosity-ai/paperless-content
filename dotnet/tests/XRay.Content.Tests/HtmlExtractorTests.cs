...
public class HtmlExtractorTests
{
    ...
    public void Html_ImagePlaceholderAndUri()
    {
        ...
        Assert.Contains(doc.Uris, u => u.Url == "test.png" && u.Kind == XRay.Content.Types.UriKind.Image);
    }
    ...
    public void Jats_AuthorsAndKeywordsAndDoi()
    {
        ...
        Assert.Contains(doc.Uris, u => u.Url == "https://doi.org/10.1/x" && u.Kind == XRay.Content.Types.UriKind.Citation);
    }
