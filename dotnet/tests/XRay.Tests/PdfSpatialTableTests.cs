...
using XRay.Internal.PdfOxide.Layout;
using XRay.Internal.PdfOxide.Text;
using Xunit;
...
public class PdfSpatialTableTests
{
    ...
    private static XRay.Internal.PdfOxide.OxTextSpan OxSpan(
        string text, float x, float y, float width, float rotation) =>
        new()
        {
            Text = text,
            Bbox = new XRay.Internal.PdfOxide.OxRect(x, y, width, 10.0f),
            FontSize = 10.0f,
    ...
    {
        var spans = new List<XRay.Internal.PdfOxide.OxTextSpan>
        {
    ...
    public void RotatedContentOnARotatedPageIsMappedIntoTheDisplayedFrame()
    {
        ...
        span.Bbox = new XRay.Internal.PdfOxide.OxRect(59.57f, 166.21f, 53.34f, 7.5f);
    ...
    private static List<XRay.Internal.PdfOxide.OxTextSpan> Clone(
        List<XRay.Internal.PdfOxide.OxTextSpan> spans)
    {
        var copy = new List<XRay.Internal.PdfOxide.OxTextSpan>(spans.Count);
