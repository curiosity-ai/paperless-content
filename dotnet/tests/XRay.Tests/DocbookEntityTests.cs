...
public class DocbookEntityTests
{
    ...
    public void AListAfterAVariableListIsStillAList()
    {
        ...
        Assert.Contains(XRay.Types.ElementKindTag.DefinitionTerm, kinds);
        Assert.Equal(2, kinds.Count(k => k == XRay.Types.ElementKindTag.ListItem));
        Assert.DoesNotContain(XRay.Types.ElementKindTag.DefinitionDescription, kinds.Skip(kinds.IndexOf(XRay.Types.ElementKindTag.ListItem)));
    }
}
